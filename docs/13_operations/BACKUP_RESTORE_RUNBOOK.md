...
**Cadence (current, minimum viable):** manual, before every deploy that includes
a migration, and at least weekly. Automated nightly backup is registered debt
(TD-P0-BACKUP in the debt register) — Sprint 3 scope, not this sprint.
...
Next drill due: **2026-08-20** (monthly, per Constitution VI.5).
